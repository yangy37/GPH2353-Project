...
A multiple regression was used to study whether the effect of the BMI number on Country's Developing levels.
Results indicated that both BMI and Country's Developing levels are both associated with the academic performance of the school.
The interaction between BMI and Country's Developing levels was not significant.
...
lmod_trans<-lm(Life.expectancy ^(0.920202) ~ Adult.Mortality + infant.deaths + Alcohol + 
