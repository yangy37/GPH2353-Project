...
lmod_trans<-lm(Life.expectancy ^(0.920202) ~ BMI + Adult.Mortality+ infant.deaths + under.five.deaths + HIV.AIDS
           + Income.composition.of.resources + Schooling + Developing +  BMI : Developing, data = data_tr)
summary(lmod_trans)
dwtest(lmod_trans)
